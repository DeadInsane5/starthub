...
export default function ProfilePage() {
  ...
  const profileForm = useForm<z.infer<typeof profileFormSchema>>({
    ...
    defaultValues: {
      ...
      bio: "Passionate entrepreneur building the next big thing in tech. Looking for investors and collaborators.",
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm">TechStartup Inc.</span>
                </div>
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <a href="https://example.com" className="text-sm text-primary hover:underline">
                    example.com
                  </a>
                </div>
                <Separator />
